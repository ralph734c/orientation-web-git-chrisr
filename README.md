...
This GitHub repository will walk you through setting up your Git and GitHub accounts. This project intends to ensure your computer's environment is set up correctly and to give a preview of the Git workflow.  A deeper dive into Git with additional functionality and explanations of each command will be part of your continued learning at BloomTech.
...
## View this README
The first step is complete! Welcome, and good luck with the next steps!  
If you encounter issues, please visit the Hub's discussion forums or submit a ticket for assistance.
...
If you still need to create a GitHub account, follow this [GitHub](https://github.com/) link.
> Click Sign Up and follow the instructions.
> During setup, you must verify your email, which is likely the final step.
...
*This step must be completed once per different computer you will use.*
...
*This step will need to be completed once per repository you wish to have your copy of on GitHub*
1. On the GitHub page, this README is located near the top right; select `Fork.`
2. Under `Owner,` select your account.
3. Under `Repository name,` you may adjust the repository name if you like.
...
3. Your next goal is to open that file and edit it. The instructions below will use a basic text editor, but you may open the file any way you wish to modify the text inside.  
...
4. Place an `x` in each step you completed of the Checklist. This is simulating you modifying files while working on a project.  
    You should not yet place an `x` in the Committing Changes Locally or Moving Changes to GitHub.
4. Save your changes/
...
*This step will typically be done once or twice on a project. Larger projects may require you to complete this step many times.*
...
*This step will typically be done once or twice on a project. If connected to Codegrade, this will cause your project to be scored again.*
1. Type:
    ```
    git push
    ```
...
This was a minimal dive into Git to ensure your computer's environment is set correctly. A deeper dive into Git with additional functionality and explanations will be part of your continued learning at BloomTech.
